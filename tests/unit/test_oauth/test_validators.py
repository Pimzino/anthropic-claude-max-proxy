...
class TestTokenValidators:
    ...
    def test_token_prefix_variations(self):
        ...
        # Test oat01 prefix (long-term) - must be > 20 chars
        assert is_long_term_token_format("sk-ant-oat01-test123456789abcdef") is True
        assert validate_token_format("sk-ant-oat01-test123456789abcdef") is True
